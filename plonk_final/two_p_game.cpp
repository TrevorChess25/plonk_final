...
void two_p_game::Init(sf::RenderWindow* window) {
...
void two_p_game::Update(sf::RenderWindow* window) {
...
void two_p_game::Render(sf::RenderWindow* window) {
...
void two_p_game::Destroy(sf::RenderWindow* window) {
	delete this->player1;
	delete this->player2;
